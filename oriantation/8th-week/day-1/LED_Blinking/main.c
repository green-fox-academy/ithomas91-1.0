...
int main(void)
{
    ...
    TimHandle.Init.Prescaler		= 10800/2 - 1;	/* 108000000/10800=10000 -> speed of 1 count-up: 1/10000 sec = 0.1 ms */
    ...
    __HAL_RCC_GPIOF_CLK_ENABLE();
        ...
        LEDS.Pin = GPIO_PIN_8;	/* setting up 2 pins at once with | operator */
