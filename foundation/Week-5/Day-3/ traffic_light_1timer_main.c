...
int main(void) {
	...
	while (1) {
		...
		HAL_GPIO_WritePin(GPIOF, GPIO_PIN_9, tim_val > 8000 && tim_val < 12000); 	//Amber light with Red
		...
		HAL_GPIO_WritePin(GPIOF, GPIO_PIN_9, tim_val > 18000 && tim_val < 24000); // Amber light only
